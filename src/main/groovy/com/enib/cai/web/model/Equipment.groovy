...
class Equipment extends Article
{
    ...
    //For static init
    public Equipment(String id, String name, String description, String img, int availability, int cost , Ability ability)
    {
    ...
    public Equipment(DBObject object)
    {
        super(object)
    ...
    {
        DBObject dbEquipment = super.getDBObject()

        dbEquipment.put("ability", this.ability.getHashmap())
